...
Despite the ten-year time gap and the differences in travel purposes, we found a significant positive correlation between estimated vehicle flows according to the 2011 Census-based route network and the ANPR sensors. 
The R-squared was 0.3 (Figure \@ref(fig:3))
