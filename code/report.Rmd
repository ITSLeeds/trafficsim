...
Figure @ref/(fig:resid) shows the model residuals.
Negative residuals mean the ANPR vehicle counts are lower than the fitted value from the model with the Census rnet, while positive residuals mean the ANPR counts are higher than the fitted value.
...
```{r resid, fig.cap="Residuals from a linear model of vehicle numbers from the ANPR plates data as a function of the vehicle numbers from the 2011 Census commute route network. Circles show residuals"}
knitr::include_graphics("https://user-images.githubusercontent.com/52210872/228830570-b7f3cfd7-5a6d-4e0a-a48a-f9853966bfba.jpg")
```
